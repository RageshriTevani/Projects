...
const Navbar=()=>{
  ...
  useEffect(()=>{
    ...
    return(
      <>
        <section className="NAVBAR p-5 mx-20 mt-5 max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR flex  justify-between capitalize">
          <div className="LOGO">
            <a href="#" className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent dark:text-cyan-500 max-sm:text-2xl"
            >{'<Rageshri/>'}</a>
          </div>
